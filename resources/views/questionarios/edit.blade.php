...
<body>
    <form action="{{ route('editar_pergunta', ['id' => $questionario->id]) }}" method="POST">
        @csrf
        <label for="nomeAvaliador">Nome do Avaliador</label> <br />
        <input type="text" name="nomeAvaliador" value="{{ $questionario->nomeAvaliador }}"> <br />

        <label for="pergunta">Pergunta</label> <br />
        <input type="text" name="pergunta" value="{{ $questionario->pergunta }}"> <br />

        <label for="peso">Peso</label> <br />
        <input type="integer" name="peso" value="{{ $questionario->peso }}"> <br /> <br />
